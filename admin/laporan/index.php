...
<head>
<meta charset="UTF-8">
<title>Laporan Penjualan - Kasir Fahri</title>
...
<div class="d-flex">
    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 no-print">
            ...
            <button class="btn btn-navy fw-bold shadow-sm" onclick="window.print()">
                <i class="fas fa-print me-2"></i>Cetak Laporan
            </button>
        </div>

        <!-- FILTER -->
        <div class="card filter-box mb-4 no-print">
            <div class="card-body">
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-6 d-flex gap-2">
                        <button type="submit" class="btn btn-navy flex-grow-1 fw-bold">
                    ...
                    <table class="table align-middle">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="fw-semibold"><?= $d['NamaPelanggan']; ?></td>
                                <td class="text-end">
